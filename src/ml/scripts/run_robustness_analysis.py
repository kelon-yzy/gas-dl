...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--n-perturbations", type=positive_int, default=10, help="MC perturbation count per modality.")
    parser.add_argument("--stacking-folds", type=positive_int, default=3, help="OOF folds for Ridge meta learner.")
